...
//primeiro fazer o cadastro do cliente
//reserva
...
void resultadoFaturamento(
soma, contreserva,somanaopg,contreservanaopg, somapg,
contreservapg, somaS, somanS, contS, somaC, somanC,
contC, somaM, somanM, contM, somaP, somanP, contP);
...
void menuCliente(){
    ...
    printf("\n2|Escolha 2 para Cadastro de clientes..................|");
    printf("\n3|Escolha 3 para visualizar as reservas................|");
    printf("\n0|Escolha 0 para sair do sistema...................|\n\n");
}
...
void LeitorFaturamento(ReservaA reserva[], int *nReservas){
    ...
    resultadoFaturamento(soma, contreserva,somanaopg,contreservanaopg, somapg, contreservapg, somaS, somanS, contS, somaC, somanC, contC, somaM, somanM, contM, somaP, somanP, contP);
}

void resultadoFaturamento(soma, contreserva,somanaopg,contreservanaopg, somapg, contreservapg, somaS, somanS, contS, somaC, somanC, contC, somaM, somanM, contM, somaP, somanP, contP ){
    printf("\n===========================\n");
    printf("\nFaturamento Geral");
    printf("\nR$%.2f", soma);
    printf("\nForam %d reservas\n", contreserva);
